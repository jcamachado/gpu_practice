...
namespace ud {
    ...
    void MultiViewRenderSystem::createPipelineLayout(VkDescriptorSetLayout globalSetLayout, VkDescriptorSetLayout textureSetLayout) {
    ...
    void MultiViewRenderSystem::renderGameObjects(FrameInfo& frameInfo) {
        ...
        /*
            Maybe a for loop here to bind all the descriptor sets
        */
        ...
        vkCmdBindDescriptorSets(
            ...
            VK_PIPELINE_BIND_POINT_GRAPHICS,
            pipelineLayout,
            1, // Bind the texture descriptor set at set 1
            1,
