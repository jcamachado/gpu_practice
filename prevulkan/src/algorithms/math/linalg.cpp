...
//     // c is the coefficients of the linear combination which means that c[0] * A + c[1] * B + c[2] * N = point
//     glm::vec3 c = linCombSolution(A, B, N, point);      

//     // check if the coefficients are in the range [0, 1]. If they are, the point is in the triangle
